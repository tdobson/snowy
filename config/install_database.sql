...
CREATE TABLE IF NOT EXISTS sn_projects (
    ...
    pv_number VARCHAR(255) NOT NULL, -- PV number, unique to each project, following the pattern 'PV[0-9]{6}'. Source: this is derived from the Projects Sheet,
...
CREATE TABLE IF NOT EXISTS sn_project_process (
    ...
    project_id CHAR(36), -- Foreign Key: Links to the corresponding project in sn_projects.
...
CREATE TABLE IF NOT EXISTS sn_plots (
    ...
    postal_postcode VARCHAR(10),    -- Postal code for the plot.
    plot_approved BOOLEAN,           -- Boolean indicating whether the plot has been approved.
    dno_zone VARCHAR(255),           -- Zone identifier for the DNO (Distribution Network Operator). //todo
...
CREATE TABLE IF NOT EXISTS sn_clients (
    ...
    client_address_1 VARCHAR(255),        -- First line of the client's address.
    client_address_2 VARCHAR(255),        -- Second line of the client's address.
    client_address_3 VARCHAR(255),        -- Third line of the client's address.
    client_town VARCHAR(255),             -- Town of the client's address.
    client_county VARCHAR(255),           -- County of the client's address.
    client_postcode VARCHAR(10),          -- Postcode of the client's address.
...
CREATE TABLE IF NOT EXISTS sn_form_submissions (
    ...
    dm_submission_id VARCHAR(255) NOT NULL, -- Device magic key
...
CREATE TABLE IF NOT EXISTS sn_region (
    ...
    region_number INT NOT NULL,             -- Numerical representation of the region.
...
CREATE TABLE IF NOT EXISTS sn_mcs_ref_counties (
    ...
    mcs_county_name VARCHAR(255) NOT NULL,             -- the name of the county
