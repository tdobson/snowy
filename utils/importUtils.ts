const ImportEvent = require('../models/importEvent');
 ...
 *
 * @param {Object} req - The Express request object containing the body with import details.
 ...
 */
exports.createImportEvent = async (req, userId) => {
    try {
 ...
 *
 * @param {Object} req - The Express request object containing the body with modification details.
 ...
 */
exports.createModificationEvent = async (req, userId, importId) => {
    try {
